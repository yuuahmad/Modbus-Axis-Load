...
#define ID_M 1                                    // Modbus ID Axis Driver X
#define ID_M 2                                    // Modbus ID Axis Driver Y
#define ID_M 3                                    // Modbus ID Axis Driver Z
#define ID_M 4                                    // Modbus ID Spindle Inverter 
...
void DRV_TRQ(){
  ...
  for(char i = 0;i<ToR;i++){
    DATA_MODBUS[i] = readModbusFloat(ID_M,addr[0]);
  }
}
